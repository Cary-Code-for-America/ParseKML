...
fw = open("/Users/robertca/Downloads/CFA/polyCoords_20140409.js","w")
...
for line in fo:
	...
	if (foundFolder == 1):
		...
		if (processCoordinates == 1):			
			...
			fw.write("],{\n")
			fw.write("color: 'red',\n")
			fw.write("fillColor: '#f03',\n")
			fw.write("fillOpacity: 0.5\n")
   			fw.write("}).addTo(map).bindPopup('<a href=\"" + descLine+ "\" target=\"_blank\">" + projName + "</a><br>" + commentLine + "');\n\n")
			processCoordinates = 0
